/**
 * auth.js — Authentication handler for Oracle PeopleSoft
 * Supports: SSO (SiteMinder / PeopleSoft SSO), MFA (Duo / RSA SecurID)
 *
...
const BASE_URL = process.env.PEOPLESOFT_URL || 'https://your-instance.example.com/psp/ps/EMPLOYEE/HRMS/h/?tab=DEFAULT';
const USERNAME = process.env.PEOPLESOFT_USERNAME;
const PASSWORD = process.env.PEOPLESOFT_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set PEOPLESOFT_USERNAME and PEOPLESOFT_PASSWORD in .env`);
  }

  console.log('Logging in to Oracle PeopleSoft...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
